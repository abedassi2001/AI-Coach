...
from frontend.analysis_view import AnalysisSummary, FullAnalysisView
from frontend.video_modal import watch_annotated_button, watch_upload_button
from frontend.ui_score import render_dimension_grid, render_issue_explanation, render_rep_breakdown_card
from frontend.ui_states import render_score_badge, render_score_ring
...
def _reset_analysis_state() -> None:
    from frontend.video_modal import clear_video_modal_request
