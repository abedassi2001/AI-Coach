...
from app.components import load_form_analysis
from app.gym_theme import inject_gym_theme, render_hero
from app.ui_panels import render_full_analysis_panel, show_summary_modal, _reset_analysis_state
from app.ui_states import render_empty_state, render_error_state, render_loading_state
from app.video_modal import (
...
from src.utils.web_video import resolve_playable_path
...
with tab_upload:
    ...
    if result is not None and status == "complete":
        ...
        if analysis:
            from app.ui_panels import render_inline_analysis_summary
